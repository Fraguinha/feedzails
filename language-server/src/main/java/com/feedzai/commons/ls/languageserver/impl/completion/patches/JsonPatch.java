...
import com.feedzai.commons.option.jackson.OptionModule;
...
public class JsonPatch {
  ...
  public String toSchema() {
    try {
      ...
      return objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(this.schema);
    } catch (JsonProcessingException e) {
      this.logger.error("Error converting schema to string", e);
      return null;
    }
  }
